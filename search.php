...
<div class="search-container">
    <form action="search_product.php" method="post">
        <input type="text" name="search-item" id="search-item" placeholder="search products">
        <button type="submit" name="Submit" id=search_product><i class="fa-solid fa-magnifying-glass"></i></button>
    </form>
</div>
</div> 
...
<?php
  ...
  $sql="SELECT * FROM product ORDER BY RAND() LIMIT 4 ";
	...
	$sendsql = mysqli_query($connect, $sql);
      ...
      echo "<h2 style=\"text-align:center;\">Recommended Combination</h2>";
      echo "<div class=\"row\">";
