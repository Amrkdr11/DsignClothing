	...
	if(isset($_GET['id'])){
                ...
                echo "<div class=\"wrapper row\">";
                  ...
                  echo "<div class=\"details col-md-6\">";
                    ...
                    echo "<div class=\"action\">";
                      echo "<button class=\"add-to-cart btn btn-default\" type=\"submit\" name=\"addCart\">Add To Cart</button>";
                    echo "</div>";
                  echo "</div>";
                echo "</div>";
              echo "</div>";
      ...
      if (isset($_POST['addCart'])) {
        ...
        $productId=$row['PRODUCT_ID'];
				...
				$sql3="INSERT INTO orders (ORDER_QTY,ORDER_PRICE,CUST_ID,PRODUCT_ID) VALUES ('$quantity','$price','$userId','$productId')";
